...
let product = document.getElementById("product-input");
...
let poly = document.getElementById("polyline-wrapper");
window.onload = function() {
    checkChild(product, proSource);
    checkChild(region, regSource);
}
